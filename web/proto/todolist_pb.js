 ...
 * @return {?proto.todolist.Item}
 */
proto.todolist.PostItemRequest.prototype.getItem = function() {
  return /** @type{?proto.todolist.Item} */ (
    jspb.Message.getWrapperField(this, proto.todolist.Item, 1));
};
...
*/
proto.todolist.PostItemRequest.prototype.setItem = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.todolist.PostItemRequest} returns this
 */
proto.todolist.PostItemRequest.prototype.clearItem = function() {
  return this.setItem(undefined);
};
 ...
 * @return {boolean}
 */
proto.todolist.PostItemRequest.prototype.hasItem = function() {
  return jspb.Message.getField(this, 1) != null;
};
